...
const navigateToDeepScreen = debounce(
  (stacks: string[], screen: string, params?: any) => {
    ...
    if (navigationRef.current?.isReady()) {
      navigationRef.current?.dispatch(CommonActions.navigate(stacks[0], obj));
    }
  },
  DELAY_TIMER,
  {leading: true, trailing: false},
